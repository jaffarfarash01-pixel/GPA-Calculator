...
calbtn.addEventListener("click", () => {
  ...
  subjects.forEach((item) => {
    ...
    if (item.grade === "O") gradePoint = 10;
    else if (item.grade === "A+") gradePoint = 9;
    else if (item.grade === "A") gradePoint = 8;
    else if (item.grade === "B+") gradePoint = 7;
    else if (item.grade === "B") gradePoint = 6;
    else if (item.grade === "C") gradePoint = 5;
    else if (item.grade === "P") gradePoint = 4;
